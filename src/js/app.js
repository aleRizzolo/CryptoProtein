App = {
  ...
  init: async function() {
    ...
    $.getJSON('../items.json', function(data) {
      ...
      for (i = 0; i < data.length; i ++) {
        ...
        itemTemplate.find('.healthcoin').text(data[i].price/1000000000000000000);
  ...
  transactionSuccess: function(price) {
    ...
    alert("Transazione eseguita con successo: " + price/1000000000000000000 + "HealthCoin");
  },
...
web3.eth.getAccounts(function(error, accounts) {
  ...
  App.contracts.HealthCoin.deployed().then(function(instance) {
